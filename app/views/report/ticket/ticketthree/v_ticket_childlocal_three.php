...
<style type="text/css">
	...
	.container_three_childlocal #cont_left_three{
		float:left;
		width:3.7cm;
		height:100%;
		border-right:0px dotted black;
	}
	.container_three_childlocal #cont_center_three{
		float:left;
		width:9.2cm;
		height:100%;
		border-right:0px dotted black;
	...
	.container_three_childlocal #cont_right_three{
		float:left;
		width:4.2cm;
		height:100%;
		border-right:0px dotted black;
	...
	.container_three_childlocal #check_date_three{
		float: left;
		width: 2.29cm;
		height: 100%;
		border-right: 0px dotted black;
...
?>
<div class="container_three_childlocal">
