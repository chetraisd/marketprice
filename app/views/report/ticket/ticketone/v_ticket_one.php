...
<style type="text/css">
	...
	.container_one_chillocal #cont_left_one{
		float:left;
		width:3.8cm;
		height:100%;
	...
	.container_one_chillocal #cont_center_one{
		float:left;
		width:9.2cm;
		height:100%;
		border-right:0px dotted black;
	...
	.container_one_chillocal #cont_right_one{
		float:left;
		width:4.2cm;
		height:100%;
		border-right:0px dotted black;
	...
	.container_one_chillocal #check_date_one{
...
?> 
<div class="container_one_chillocal">
	<div id="cont_left_one">
		...
		<?php
			...
			// type of QRcode "L","M","Q","H"
			QRcode::png($ticket, $filename, "L", 1, 10);
