...
<style type="text/css">
	...
	.container_one_chilfor #cont_left_one{
		float:left;
		width:3.8cm;
		height:100%;
	...
	.container_one_chilfor #cont_center_one{
		float:left;
		width:9.2cm;
		height:100%;
		border-right:0px dotted black;
	...
	.container_one_chilfor #cont_right_one{
		float:left;
		width:4.2cm;
		height:100%;
		border-right:0px dotted black;
	...
	.container_one_chilfor #check_date_one{
...
?> 
<div class="container_one_chilfor">
	...
	<div id="check_date_one" style="color:#E6DB5A;">
