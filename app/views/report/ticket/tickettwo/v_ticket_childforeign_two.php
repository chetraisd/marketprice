...
<style type="text/css">
	...
	.container_two_childfor #cont_left_two{
		float:left;
		width:3.7cm;
		height:100%;
	...
	.container_two_childfor #cont_center_two{
		float:left;
		width:9.2cm;
		height:100%;
		border-right:0px dotted black;
	...
	.container_two_childfor #cont_right_two{
		float:left;
		width:4.2cm;
		height:100%;
		border-right:0px dotted black;
	...
	.container_two_childfor #check_date_two{
		float: left;
		width: 2.29cm;
		height: 100%;
		border-right: 0px dotted black;
...
?>
<div class="container_two_childfor">
