...
<style type="text/css">
	...
	.container_two_adultlocal #cont_left_two{
		float:left;
		width:3.7cm;
		height:100%;
	...
	.container_two_adultlocal #cont_center_two{
		float:left;
		width:9.2cm;
		height:100%;
		border-right:0px dotted black;
	...
	.container_two_adultlocal #cont_right_two{
		float:left;
		width:4.2cm;
		height:100%;
		border-right:0px dotted black;
	...
	.container_two_adultlocal #check_date_two{
		float: left;
		width: 2.29cm;
		height: 100%;
		border-right: 0px dotted black;
...
<div class="container_two_adultlocal">
	<div id="cont_left_two">
		...
		<?php
			...
			$filename1 = $PNG_TEMP_DIR.'/'.$ticket.'.png';
			QRcode::png($ticket, $filename1, "L", 1, 4);

		?>
		<span style="float:left;margin:20px 0 0 5px;">
			<img src="<?php echo site_url('app/views/report/ticket/tickettwo/temp/'.basename($filename1));?>">
		</span>
	</div>
	...
	<div id="check_date_two">
		<!-- <?php // echo $show_park;?>
		<div id="tick_check" style="width:100%;height:49%;float:left;border-bottom: 1px dotted black;">
			<p style="margin:0;font-size:8px;padding-top:50px;"><b><?php //echo $parkname2[1];?></b></p>
			<p style="margin:0;font-size:8px;">PHẦN KIỂM SOÁT</p>
		</div>
		<div id="tick_check" style="width:100%;height:49%;float:left;border-bottom: 0px dotted black;">
			<p style="margin:0;font-size:8px;padding-top:50px;"><b><?php //echo $parkname2[2];?></b></p>
			<p style="margin:0;font-size:8px;">PHẦN KIỂM SOÁT</p>
		</div> -->
	</div>
</div>
