...
<style type="text/css">
	...
	.container_four_adultlocal #cont_left_four{
		float:left;
		width:3.7cm;
		height:100%;
	...
	.container_four_adultlocal #cont_center_four{
		float:left;
		width:9.2cm;
		height:100%;
		border-right:0px dotted black;
	...
	.container_four_adultlocal #cont_right_four{
		float:left;
		width:4.2cm;
		height:100%;
		border-right:0px dotted black;
	...
	.container_four_adultlocal #check_date_four{
		float: left;
		width: 2.29cm;
		height: 100%;
		border-right: 0px dotted black;
...
?> 
<center>
<div class="container_four_adultlocal">
