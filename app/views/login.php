                        ...
                        <table class="">
                            <tr>
                                ...
                                <td colspan="3" align="left" class="login_title">
                                    <span class="" style="font-family: 'Khmer OS Muol light' "><?php echo $this->lang->line('system_name'); ?></span>
                                </td>
                            </tr>

                            <tr>
                                <td class="no-wrap"><?php echo $this->lang->line('user_name') ?></td>
                                <td>:</td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>:</td>
                                <td>
                                    <select name="lang" id="lang" class="form-control col-sm-4">
