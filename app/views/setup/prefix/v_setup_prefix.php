<html>
<title>Create Ticket Series</title>
<body>
<div class="wrapper">
	<div class="col-sm-12">
    	<div class="panel-heading">
        	<div class="row result_info">
            	<div class="col-xs-6">
        		<strong>Ticket Series Format</strong>
                </div>
            </div>
            ...
            <div class="row">
            	 ...
            	 <div class="col-sm-12">
                 	...
                 	<div class="col-sm-6">
                    	<label class="control-label">Series<span style="color:red">*</span></label>
                ...
                <div class="col-sm-12">
                 	<div class="col-sm-6">
                    	<label class="control-label">Running Number</label>
                        <input readonly type="text" name="sequence" id="sequence" class="form-control input-xs" value="1" />
                    </div> 
                 	<div class="col-sm-6">
	 ...
	 <div class="col-sm-12">
        <div class="row result_info">
            <div class="col-sm-6"><strong>Series List</strong></div>
        </div>
         ...
         <table class="table table-condensed table-striped">
            <thead>
                <tr>
					...
					<th class="col-xs-2">Park/Package</th>
                    <th class="col-xs-2">Series</th>
                    <th class="col-xs-3">Symbol</th>
                    <th class="col-xs-1">Length</th>
                    <th class="col-xs-1">Year</th>
                    <th class="col-xs-3">Running Number</th>
		...
		this.fn_delete = function fn_delete(code_delete){
			...
			$.ajax({
				...
				success:function(data){
					var delel = data;
					if(delel>0){
						alert("This prefix can not delete. data in processed");
						return false;
					}else{							
